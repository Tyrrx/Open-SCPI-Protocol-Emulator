...
{
    [TestClass]
    public class Keysight3458AParserIntegrationTests
    {
        [TestMethod]
        ...
        public void Test_SCPI_ConfigureCurrent_Command()
        {
            ...
            AssertCommandType<Keysight3458ACommand.ConfigureCurrent_>("CONF:CURR:AC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.ConfigureCurrent_>("CONFigure:CURRent:AC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.ConfigureCurrent_>("CONF:CURR:DC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            AssertCommandType<Keysight3458ACommand.ConfigureCurrent_>("CONFigure:CURRent:DC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            // Test defaults
        ...
        {
            //Test long form and short form with ac and dc
            AssertCommandType<Keysight3458ACommand.MeasureCurrent_>("MEAS:CURR:AC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.MeasureCurrent_>("MEASure:CURRent:AC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.MeasureCurrent_>("MEASure:CURR:DC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            AssertCommandType<Keysight3458ACommand.MeasureCurrent_>("MEASure:CURRent:DC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            // Test defaults
        ...
        {
            AssertCommandType<Keysight3458ACommand.ConfigureVoltage_>("CONF:VOLT:AC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.ConfigureVoltage_>("CONFigure:VOLTage:AC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.ConfigureVoltage_>("CONF:VOLT:DC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            AssertCommandType<Keysight3458ACommand.ConfigureVoltage_>("CONFigure:VOLTage:DC").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            // Test defaults
        ...
        {
            AssertCommandType<Keysight3458ACommand.MeasureVoltage_>("MEAS:VOLT:AC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.MeasureVoltage_>("MEASure:VOLTage:AC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.AC_>();
            AssertCommandType<Keysight3458ACommand.MeasureVoltage_>("MEAS:VOLT:DC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            AssertCommandType<Keysight3458ACommand.MeasureVoltage_>("MEASure:VOLTage:DC?").ElectricCurrentType.Should().BeOfType<ElectricCurrentType.DC_>();
            // Test defaults
        ...
        {
            var commands = new Keysight3458AProtocolParser().GetCommand(input);
        ...
        {
            new Keysight3458AProtocolParser().GetCommand(input).Should().BeOfType<Error<Keysight3458ACommand>>();
        }
