...
{
    [TestClass]
    public class TestConfigureCurrent
    {
        [TestMethod]
        public void TestOfDeviceAccordingToGivenParameters_Defaults()
        {
            // Arrange
            var electricalUnitOfMeasure = new BehaviorSubject<ElectricalUnitOfMeasure>(ElectricalUnitOfMeasure.Voltage);
            ...
            // Act
            var result = ConfigureCurrent.OfDeviceAccordingToGivenParameters(
                measuringInstrument,
            ...
            electricalUnitOfMeasure.Value.Should().Be(ElectricalUnitOfMeasure.Current);
        }
