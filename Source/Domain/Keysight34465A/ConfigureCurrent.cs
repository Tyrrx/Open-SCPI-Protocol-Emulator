...
namespace Domain.Keysight34465A
{
    public static class ConfigureCurrent
    {
        ...
        {
            keysight34465A.ElectricalUnitOfMeasureBehaviorSubject.OnNext(ElectricalUnitOfMeasure.Current);
            ...
            keysight34465A.RangeBehaviorSubject.OnNext(range.Match(
                some => some,
                () => Range.Auto));
            keysight34465A.ResolutionBehaviorSubject.OnNext(resolution.Match(
                some => some,
                () => Resolution.Def));
