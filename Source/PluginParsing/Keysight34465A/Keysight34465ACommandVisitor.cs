...
using PluginParsing;
using PluginParsing.GeneratedKeysight34465A;
using PluginParsing.Keysight34465A;

namespace PluginInterpreter.Keysight34465A
{
    public class Keysight34465ACommandVisitor : Keysight34465ASCPIBaseVisitor<Result<Keysight34465ACommand>>
    {
            ...
            [NotNull] Keysight34465ASCPIParser.ConfigureCurrentCommandContext context)
        {
            ...
            {
                Keysight34465ASCPILexer.AC => ElectricCurrentType.AC,
                Keysight34465ASCPILexer.DC => ElectricCurrentType.DC,
